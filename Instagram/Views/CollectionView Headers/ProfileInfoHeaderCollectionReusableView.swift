...
final class ProfileInfoHeaderCollectionReusableView: UICollectionReusableView {
    ...
    private let bioLabel: UILabel = {
        let label = UILabel()
        label.text = "This is the fisrt account"
        label.textColor = .label
    ...
    private func addButtonAction() {
        ...
        editProfileButton.addTarget(self,
                                  action: #selector(didTapEditPorfileButton),
                                  for: .touchUpInside)
    }
    ...
    override func layoutSubviews() {
        ...
        let countButtonWith = (width-10-profilePhotoSize)/3
        postsButton.frame = CGRect(x: profilePhotoImageView.right,
                                   y: 5,
                                   width: countButtonWith,
...
// MARK: - Actions
    ...
    @objc private func didTapEditPorfileButton() {
